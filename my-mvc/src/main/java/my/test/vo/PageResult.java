...
public class PageResult {
    ...
    /**
     * 将json结果集转化为PageResult对象
     * 
     * @param jsonData json数据
     * @param clazz PageResult中的object类型
     * @return
     */
    public static PageResult formatToPojo(String jsonData, Class<?> clazz) {
        try {
            if (clazz == null) {
                return MAPPER.readValue(jsonData, PageResult.class);
            }
     ...
     * @return
     */
    public static PageResult format(String json) {
        try {
